...
onMounted(() => {
  toast.add({ title: "如需联系上文请开启左下角携带历史记录，图像生成请输入英文描述词，模型不能使用发现会修复，由于盗刷，个别模型设置了速率限制，如报错请再次尝试。" })
  ...
  <div class="relative">
    ...
    <div class="flex items-end">
      ...
      <UTextarea v-model="input" :placeholder="$t('please_input_text') + '...'"
        @keydown.prevent.enter="handleInput($event)" @paste="handlePaste" autofocus :rows="1" autoresize
